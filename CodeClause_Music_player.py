...
resume_btn = Button(button_frame, text='Resume', bg='magenta', font=("Georgia", 13), width=7,
                    command=lambda: resume_song(song_status))
resume_btn.place(x=285, y=10)

load_btn = Button(button_frame, text='Load Directory', bg='antique white', font=("Georgia", 13), width=35, command=lambda: load(playlist))
